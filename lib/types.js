...
// NOTE(oren): for whatever reason the SlowBuffer provided by our
// polyfill plugin doesn't work correctly. Fall back to buffer.Buffer
// unconditionally as a temporary hack.
var SlowBuffer = buffer.Buffer;
